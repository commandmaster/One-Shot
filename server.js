...
class ServerScene {
  ...
  create() {
    ...
    // load the world
    const levelLoader = new LoadJsonToServer(this, require('./public/practiceRange/practiceRange.json'))
  ...
  loadLevel(){
      for (const object of this.json.sceneObjects){
          ...
          if (object.type === "cube" || object.type === "box"){
              ...
              this.serverScene.objects.push(tempBox);
              
              console.log(tempBox.position.y)
          }
